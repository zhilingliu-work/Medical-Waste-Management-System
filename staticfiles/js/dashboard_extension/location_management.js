...
class LocationManager {
    ...
    startAddLocation() {
        ...
        newRow.innerHTML = `
            ...
            <td><div class="ts-input is-solid is-fluid is-small"><input type="text" class="edit-code" placeholder="輸入定點代碼" style="background: var(--my-bg-input); color: var(--my-text-main);"></div></td>
        ...
        const input = newRow.querySelector('.edit-code');
    ...
    startEditLocation(e) {
        ...
        codeCell.innerHTML = `<div class="ts-input is-solid is-fluid is-small"><input type="text" class="edit-code" value="${codeCell.textContent.trim()}" style="background: var(--my-bg-input); color: var(--my-text-main);"></div>`;
        ...
        const input = row.querySelector('.edit-code');
